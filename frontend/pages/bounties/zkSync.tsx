const zkSyncBountyDetail: React.FC = () => {
    return (
      <div className="p-4">
        <h1 className="text-2xl font-bold mb-4">zkSync</h1>
        <div className="mb-4">
          <h2 className="text-xl font-bold">Program Details</h2>
          <p><strong>Platform:</strong> Immunefi</p>
          <p><strong>Duration:</strong> Continuous</p>
          <p><strong>Vulnerabilities Found:</strong> N/A</p>
          <p><strong>Average Payout:</strong> N/A</p>
          <p><strong>Maximum Payout:</strong> $2,300,000</p>
          <p><strong>Severity Levels:</strong> Critical, High, Medium, Low</p>
          <p><strong>Scope:</strong> Smart Contracts, Blockchain/DLT, Websites and Applications</p>
          <p><strong>Submission Requirements:</strong> PoC required for critical and high severity reports</p>
          <p><strong>Response Time:</strong> N/A</p>
          <p><strong>Reputation and Reviews:</strong> N/A</p>
          <p><strong>Last Retrieved:</strong> 2024-05-22</p>
          <p><strong>Retrieve Type:</strong> Manual</p>
        </div>
        <div className="mb-4">
  ...
  export default zkSyncBountyDetail;
