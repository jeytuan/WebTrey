...
# Directly define API_HOST
API_HOST = "https://actions-server-jeytuan-dblzzhtf5q-ew.a.run.app"

logger = logging.getLogger(__name__)

# Mock WorkspaceClient and EndpointsClient for testing purposes
class WorkspaceClient:
    def __init__(self, api_host):
        self.api_host = api_host

    def get(self):
        return type('obj', (object,), {'url': API_HOST})()
...
class EndpointsClient:
    ...
    def list(self, params):
        return type('obj', (object,), {'root': [{'uri': API_HOST}]})()
...
def get_workspace_uri() -> str:
    ...
    try:
        ...
        logger.error(
            "Please check that you have created a workspace using the Giza CLI"
        )
        raise
